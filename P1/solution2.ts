...
async function solution() {
  ...
  readInterface.on("line", function (line) {
    ...
    // Get all the matches and flatten the array
    ...
    // If there are no matches, log the line and continue
    ...
    // If either of the matches are undefined, throw an error.
    // This only works because if one is undefined, the other will be too since we used at(-1)
